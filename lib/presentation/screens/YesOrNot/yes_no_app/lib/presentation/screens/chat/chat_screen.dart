...
import 'package:yes_no_app/presentation/widgets/chat/second_message_bubble.dart';
          ...
          children: [
            Expanded(
              ...
              itemBuilder: (context, index) {
                ...
                return (message.fromWho == FromWho.second)
                    ? SecondMessageBubble(message: message,)
