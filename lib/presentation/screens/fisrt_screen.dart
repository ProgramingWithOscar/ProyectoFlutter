        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment
                .start, //aliniar el scrool y que inicia desde start
            children: [
              Stack(
                //permite poner widget uno encima del otro en este caso la barra de busqueda (text field)
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        ...
                        fit: BoxFit
                            .cover, //imagen se adapte al conteiner y no se distorcione
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        //decoracion de barra de busqueda
                        ...
                        prefixIcon: const Icon(Icons
                            .search), //icono de busqyeda y prefix para que este dentro de la caja
                      ),
                ...
                child: ListView(
                  ...
                  children: [
                    ...productosComidasRapidas.map((product) => ContainerWidget(
                          ...
                          name: product['name'],
                          onTap: () {
                            //me redirecciona a otra pagina o info del producto
              ...
              ListView(
                physics:
                    NeverScrollableScrollPhysics(), //no deja que el usuario haga scroll
